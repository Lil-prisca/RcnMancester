    ...
    <section className="py-5 bg-on-primary">
      <div className="max-w-7xl mx-auto px-12">
        <div className="mb-10 text-center md:text-left">
          <h2 className=" text-5xl text-primary mb-4">Our Activities</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-8 md:py-10  lg:px-60 gap-6 h-auto md:h-220">
          ...
          <div className="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-low h-110  md:h-100">
            ...
            <div className="absolute bottom-1 w-[95%] ml-3  mx-auto  glass  rounded-2xl p-5">
              <h3 className="  text-3xl text-white">Monthly Prayer Marathon</h3>
          ...
          <div className="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-low h-110 md:h-100">
            ...
            {/* <div className="absolute bottom-10 left-4 glass  rounded-2xl p-5">
              <h3 className="  text-3xl text-white">Quier</h3>
          ...
          <div className="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-low h-110 md:h-100 text-white">
            ...
            {/* <div className="absolute inset-0 bg-gradient-to-t from-[#0e0e13] via-transparent to-transparent"></div> */}
            {/* <div className="absolute bottom-10 left-4 glass  rounded-2xl p-5">
              <h3 className="  text-3xl ">The Streets</h3>

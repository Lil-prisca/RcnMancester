...
function ProductCard({ product, index }) {
  return (
    <motion.div
      ...
      className="group rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md overflow-hidden hover:border-[#D4AF37]/30 transition-colors duration-500"
    >
